...
`${GOPATH}/src/github.com/mxyns/twitchatbeat`
...
```
git remote set-url origin https://github.com/mxyns/twitchatbeat
...
in the same directory with the name twitchatbeat.
...
```
./twitchatbeat -c twitchatbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/mxyns/twitchatbeat
git clone https://github.com/mxyns/twitchatbeat ${GOPATH}/src/github.com/mxyns/twitchatbeat
```
